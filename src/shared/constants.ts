...
export const VOICE_LISTS = {
  openai: [
    { id: "shimmer", name: "Shimmer", key: "shimmer" },
    { id: "alloy", name: "Alloy", key: "alloy" },
    { id: "ash", name: "Ash", key: "ash" },
    { id: "ballad", name: "Ballad", key: "ballad" },
    { id: "coral", name: "Coral", key: "coral" },
    { id: "echo", name: "Echo", key: "echo" },
    { id: "fable", name: "Fable", key: "fable" },
    { id: "nova", name: "Nova", key: "nova" },
    { id: "onyx", name: "Onyx", key: "onyx" },
    { id: "sage", name: "Sage", key: "sage" },
  ],
  google: [
    { id: "ja-JP-Standard-A", name: "JP Standard A (Female)", key: "ja-JP-Standard-A" },
    { id: "ja-JP-Standard-B", name: "JP Standard B (Female)", key: "ja-JP-Standard-B" },
    { id: "ja-JP-Standard-C", name: "JP Standard C (Male)", key: "ja-JP-Standard-C" },
    { id: "ja-JP-Standard-D", name: "JP Standard D (Male)", key: "ja-JP-Standard-D" },
    { id: "en-US-Standard-A", name: "US Standard A (Male)", key: "en-US-Standard-A" },
    { id: "en-US-Standard-B", name: "US Standard B (Male)", key: "en-US-Standard-B" },
    { id: "en-US-Standard-C", name: "US Standard C (Female)", key: "en-US-Standard-C" },
    { id: "en-US-Standard-D", name: "US Standard D (Male)", key: "en-US-Standard-D" },
    { id: "en-US-Standard-E", name: "US Standard E (Female)", key: "en-US-Standard-E" },
  ],
  nijivoice: [
    { key: "hanamura_honoka", id: "231e0170-0ece-4155-be44-231423062f41", name: "花村 穂ノ香" },
    { key: "shitsuya_ren", id: "04c7f4e0-41d8-4d02-9cbe-bf79e635f5ab", name: "漆夜 蓮" },
  ...
  elevenlabs: [
    { id: "3JDquces8E8bkmvbh6Bc", name: "Otan", key: "3JDquces8E8bkmvbh6Bc" },
    { id: "c6SfcYrb2t09NHXiT80T", name: "Janathan", key: "c6SfcYrb2t09NHXiT80T" },
    { id: "Mv8AjrYZCBkdsmDHNwcB", name: "Ishibashi", key: "Mv8AjrYZCBkdsmDHNwcB" },
