    ...
    <div class="flex items-center space-x-4">
      ...
      <div>
        ...
        <div class="group relative flex items-center ">
          <h1
            v-if="!isEditingTitle"
            class="cursor-pointer text-2xl font-bold max-w-128 truncate"
        ...
        <!-- Description -->
        <div class="group relative flex items-center">
          <p v-if="!isEditingDescription" class="cursor-pointer text-gray-600 max-w-128 truncate" @click="startEditingDescription">
            {{ displayDescription }}
          </p>
          <Input
            v-else
